...
<form action="{{ route('contact.confirm') }}" method="POST" class="contact-form" novalidate>
    @csrf
    ...
    <div class="form-group">
        ...
        @error('building') <div class="validation-error">{{ $message }}</div> @enderror
    </div>
    ...
    <div class="form-group required">
        ...
        @error('category_id') <div class="validation-error">{{ $message }}</div> @enderror
    </div>
    ...
    <div class="form-group required">
        ...
        @error('detail') <div class="validation-error">{{ $message }}</div> @enderror
    </div>
